...
layout (set = 1, binding = 0) uniform texture2D textureColorMap;
layout (set = 1, binding = 1) uniform sampler samplerColorMap;
layout (set = 1, binding = 2) uniform texture2D textureNormalMap;
layout (set = 1, binding = 3) uniform sampler samplerNormalMap;
...
layout (set = 1, binding = 4) uniform MaterialConsts {
	bool ALPHA_MASK;
